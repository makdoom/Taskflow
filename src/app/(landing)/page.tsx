...
const LandingPage = () => {
  return (
    <div className="h-screen">
      <BackgroundBeamsWithCollision className="!h-screen flex flex-col">
        ...
        <p className="text-2xl text-center mt-3 text-secondary-foreground">
          Project management tool designed to streamline task organization,{" "}
          <br /> enhance team collaboration, and boost productivity
        </p>
